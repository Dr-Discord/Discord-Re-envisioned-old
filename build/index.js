...
${input[0]}`, ...input.slice(1)] : ["\n", ...input];
            getOriginal(prop)(`%c  %c${i18n_1.default.name}`, `background-image:url(data:image/svg+xml;base64,${getIcon(ifDark("#202124", "#fff"))}); background-size: 24px; background-repeat: no-repeat; padding: 5px; background-color: rgb(31, 173, 78); border-radius: 4px`, `background: rgb(31, 173, 78); margin-left: 5px; margin-bottom: 9px; padding: 2px; border-radius: 4px; color: ${ifDark("#202124", "#fff")}`, ...lastArgs);
          };

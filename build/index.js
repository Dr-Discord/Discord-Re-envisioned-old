...
.dr-toast-close:hover { color: var(--interactive-hover); background-color: var(--background-modifier-hover) }`);
  ...
  var require_util = __commonJS({
    "tsBuild/util.js"(exports) {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.copyText = exports.anonymous = exports.openSetting = exports.restart = exports.findInReactTree = exports.findInTree = exports.prompt = exports.alert = exports.showConfirmationModal = exports.getOwnerInstance = exports.getReactInstance = exports.addToWindow = exports.waitUntil = exports.sleep = void 0;
      ...
      function addToWindow(key, value) {
        if (window[0])
          window[0][key] = value;
        window[key] = value;
      }
      exports.addToWindow = addToWindow;
...
.dr-select { height: 330px }`);
      ...
      var DrDashboardButton;
      (0, util_1.anonymous)(async () => {
        const { LinkButton } = await (0, getModule_1.asyncGetModule)((e) => e.LinkButton);
  ...
  var require_addonManager = __commonJS({
    "tsBuild/addonManager.js"(exports) {
      ...
      var initCard = () => {
        ...
        const { wrapper, content, title, titleRegion, icon, infoLink, infoIcon, buildInfo, buildDetails, subHead } = (0, getModule_1.default)(["titleRegion"]);
        const InfoFilled = (0, getModule_1.default)("InfoFilled").default;
        return react_1.React.memo(({ href }) => {
          const spl = href.replace("dr://", "").split("/");
          return react_1.React.createElement("div", { className: wrapper }, react_1.React.createElement(Text, { size: Text.Sizes.SIZE_12, className: titleRegion }, react_1.React.createElement("strong", { className: title }, spl[0]), react_1.React.createElement("a", { className: infoLink, onClick: (e) => {
            (0, util_1.alert)("title", "content");
          } }, react_1.React.createElement(InfoFilled, { className: infoIcon }))), react_1.React.createElement("div", { className: content }, react_1.React.createElement("div", { className: buildInfo }, react_1.React.createElement(Text, { size: Text.Sizes.SIZE_14, className: subHead }, "demoPlugin"), react_1.React.createElement(Text, { size: Text.Sizes.SIZE_16, className: buildDetails }, "demo plugin for drdiscord random test ing lol")), react_1.React.createElement(Button, { size: Button.Sizes.MEDIUM, color: Button.Colors.GREEN }, "Install")));
        });
      };
  ...
  var require_tsBuild = __commonJS({
    "tsBuild/index.js"(exports) {
      ...
      Start();
      (0, util_1.addToWindow)("__DR__BACKEND__", {
      ...
      async function Start() {
        ...
        patcher_1.default.instead("DrInternal-Addoncards-Patch", (0, getModule_1.default)(["defaultRules", "astParserFor"]).defaultRules.link, "react", (props, orig) => {
          if (!props[0].target.startsWith("dr://"))
            return;
